...
build_status_module() {
  ...
  then
    ...
    local show_icon="#[fg=$thm_dk,bg=$color,nobold,nounderscore,noitalics]$icon "
    local show_text="#[fg=$thm_fg,bg=$thm_gray] $text"
  ...
  then
    ...
    local show_icon="#[fg=$thm_dk,bg=$color,nobold,nounderscore,noitalics]$icon "
    local show_text="#[fg=$thm_dk,bg=$color]$text"
  ...
  then
    ...
    then
      ...
      local show_right_separator="#[fg=$thm_dk,bg=$color,nobold,nounderscore,noitalics]$status_right_separator"
    fi
  fi
...
main() {
  local theme
  theme="$(get_tmux_option "@gruvbox_flavour" "z3")"
  ...
  local status_modules_right=$(get_tmux_option "@gruvbox_status_modules_right" "application session")
  local loaded_modules_right=$( load_modules "$status_modules_right")

  local status_modules_left=$(get_tmux_option "@gruvbox_status_modules_left" "")
